...
def grid_search(args):
    ...
    dataset_sizes=[1000*1.25, 900000*1.25, 1800000*1.25, 2700000*1.25, 3600000*1.25, 4500000*1.25] #np.logspace(2,5,4).astype('int')
    learning_rate=0.1
    ...
    plot_data_1(dataset_sizes,test_accuracy)


def plot_data_1(dataset_sizes, test_accuracy):
    plt.figure()
    plt.plot(dataset_sizes, test_accuracy, '--b^', label='Train')
